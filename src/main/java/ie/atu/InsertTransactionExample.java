...
public class InsertTransactionExample {
    ...
    public static void main(String[] args) throws SQLException {
        ...
        Connection conn = DriverManager.getConnection("jdbc:mysql://localhost/formula1", "root", "password");
        ...
        try {
            ...
            PreparedStatement stmt = conn.prepareStatement("INSERT INTO driver (name, age) VALUES (?, ?)");
            stmt.setString(1, "Max Verstappen");
            stmt.setInt(2, 25);
            stmt.executeUpdate();
            ...
            stmt = conn.prepareStatement("INSERT INTO team (driver_id, team_name, country) VALUES (?, ?, ?)");
            stmt.setInt(1, getLastInsertId(conn));
            stmt.setString(2, "RedBull");
            stmt.setString(3, "Austria");
            stmt.executeUpdate();
